...
function renderBlock(block: ContentBlock, index: number) {
  switch (block.type) {
    case "text":
      return (
        <div key={index} className="mb-6 sample-book-block">
          {block.title && (
    ...
    case "callout": {
      ...
      return (
        <div key={index} className={`mb-6 p-4 rounded-2xl border-2 ${style.bg} ${style.border} sample-book-block`}>
    ...
    case "key_term":
      return (
        <div key={index} className="mb-5 p-4 rounded-2xl bg-secondary/10 border-2 border-secondary/20 sample-book-block">
          <div className="flex items-start gap-3">
    ...
    case "activity":
      return (
        <div key={index} className="mb-6 p-4 rounded-2xl bg-gradient-to-br from-lime/10 to-turquoise/10 border-2 border-lime/20 sample-book-block">
          <div className="flex items-start gap-3">
    ...
    case "summary":
      return (
        <div key={index} className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-primary/10 to-secondary/10 border-2 border-primary/20 sample-book-block">
          <div className="flex items-start gap-3">
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="shrink-0 p-3 border-b bg-background/95 backdrop-blur flex items-center justify-between print:hidden">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold">Sample Book Preview</span>
        </div>
